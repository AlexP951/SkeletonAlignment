...
from AlignSkeletons import AlignSkeletons
from FrameMatching import compute_angle_differences
...
offset1 = AlignSkeletons(laptop_data, iphone_data)
print(f"Peak Alignment:  {offset1}")
offset2 = compute_angle_differences(laptop_data, iphone_data)
